/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 9e6ca7195dc50644bbf79f66bdf6ff7b)
// Runtime types generated with workerd@1.20260730.1 2026-08-03 nodejs_compat
interface __BaseEnv_Env {
	DOCUMENTS: R2Bucket;
	DB: D1Database;
	KIVO_ANALYTICS: AnalyticsEngineDataset;
	INGESTION_QUEUE: Queue;
	ASSETS: Fetcher;
	KIVO_DEMO_MODE: "true";
	NEXT_PUBLIC_APP_URL: "https://kivo-web.workers.dev";
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "KIVO_DEMO_MODE" | "NEXT_PUBLIC_APP_URL">> {}
}
